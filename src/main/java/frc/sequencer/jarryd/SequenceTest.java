...
public class SequenceTest {
    ...
    private static Sequence createPos1Complex()
    {
        ...
        autoLimelight lime1 = new autoLimelight();
        autoBallShooterMain ball = new autoBallShooterMain();
        ball.setNumBalls(2);
        ...
        T1.setDelay(1.2);
        autoBallShooterMain ball2 = new autoBallShooterMain();
        ball2.setNumBalls(1);
        ...
        d7.setDist(2.5);
        d7.setSpeed(1);
        d7.setAccFwdLimit(0.13);
        d7.setAccRevLimit(0.25);
        d7.setDistGain(1.5);
        timedStep T3 = new timedStep();
        T3.setDelay(1);
        autoBallShooterMain ball3 = new autoBallShooterMain();
        ball3.setNumBalls(5);
        ...
        lime2.setNextSteps(intake);
        T1.setNextTrans(ball2, T02);
        T1.setNextSteps(shoot2,intake);
        ball2.setNextTrans(t3);
        ball2.setNextSteps(t3,intake);
        T02.setNextTrans(t3);
        T02.setNextSteps(t3,intake);
        t3.setNextTrans(d4);
        t3.setNextSteps(d4,intake);
        d4.setNextTrans(t4);
